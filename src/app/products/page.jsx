      ...
      <div className="relative mx-auto max-w-7xl px-6">
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {Product.map((p, index) => (
            <div
              key={index}
              className="group overflow-hidden rounded-2xl border border-orange-500/20 bg-[#111] transition duration-500 hover:-translate-y-2 hover:border-orange-400 hover:shadow-[0_15px_40px_rgba(255,122,0,.25)]"
            >
              {/* Image */}
              <div className="relative h-64 w-full overflow-hidden rounded-t-2xl border-b border-orange-500/30 bg-black/40 backdrop-blur-md sm:h-80 md:h-96">
                <Image
                  src={p.image}
                  alt={p.title}
                  fill
